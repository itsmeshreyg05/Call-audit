...
def apply_score_threshold(score: Any) -> str:
    """
    Applies threshold logic specifically for row_data formatting.
    - If score is None or not a number, return "0" (no %).
    - If score >= 75: return "100%"
    - If score < 75 (including 0): return "0%"
    """
    if score is None:
        return "0"
    try:
